<?php
  ...
  */
  ...
  var_dump(filter_var($ip, FILTER_VALIDATE_IP, ["flags" => FILTER_NULL_ON_FAILURE | FILTER_FLAG_IPV6])); // ولو هو اي بي فرجن 4  Null هنا الزيرو عمل كدا | عشان يتشك لو مش اي بي يديني 
  //  this bitwise operator | check all conditions and re
  // this logical operator || check the first if True it don't check the second
