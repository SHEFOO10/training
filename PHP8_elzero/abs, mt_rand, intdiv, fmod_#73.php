<?php
  ...
  */
  ...
  echo 10 / 5 . "<br>"; // 2 inger
  echo gettype(10 / 5) . "<br>";

  echo 11 / 5 . "<br>"; // 2.2 double
  echo gettype(11 / 5) . "<br>";

  echo intdiv(11, 5) . "<br>"; // 2 intger
  echo gettype(intdiv(11, 5)) . "<br>";

  echo 11.5 % 5 . "<br>"; // 1 intger
  echo gettype(11 % 5) . "<br>";

  echo fmod(11.5, 5) . "<br>"; // 1.5 double
  echo gettype(fmod(11.5, 5)) . "<br>";

//  to display in readable way on terminal use \n instead of <br>
